  ...
  return (
    <div>
      ...
      <div className="container-about">
        <p className="paragraph1" ref={abouth1}>
          I'm a 23 year-old front-end Web Developer <br />
          from <span>Serbia.</span>
          <br /> I have a passion for creating fast loading, dynamic, and responsive websites using
          the latest technologies available.
        </p>
        <div className="paragraph-flex">
          <p className="paragraph2" ref={abouth2}>
            Technologies & Tools that I use:
          </p>
          <p className="paragraph3" ref={abouth3}>
